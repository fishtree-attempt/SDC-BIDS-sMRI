...
![](fig/episode_4/Course_flow_4.png){alt="course\_flow"}
...
![](fig/episode_4/GM_WM_CSF.png){alt="Brain tissue types"}
...
![](fig/episode_4/brain_atrophy_460px.jpg){alt="Brain atrophy due to Alzheimer's or severe multiple sclerosis disease"}
...
![](fig/episode_4/brain_axial_slice.png){alt="Axial slice of the T1 data (after skull-stripping)"}
...
![](fig/episode_4/intensity_distribution_all_tissues_together.png){alt="Histogram of the T1 volume data, all tissues together"}
...
![](fig/episode_4/brain_slices_seg_overlay.png){alt="Tissue classes overlayed on the T1 data"}
...
![](fig/episode_4/intensity_distribution_per_tissue_class.png){alt="Histogram of the T1 volume data, one distribution per tissue"}
...
![](fig/episode_4/GM_probmap.png){alt="GM probability map"}
...
![](fig/episode_4/GM_WM_surfaces_delineation.png){alt="Delineation of GM and WM"}
...
![](fig/episode_4/mesh.png){alt="Delineation of GM and WM"}
...
![](fig/episode_4/mesh_pial_NC.png){alt="Pial mesh from surface segmentation"}
...
![](fig/episode_4/NC_vs_AD.png){alt="WM mesh from surface segmentation"}
...
![](fig/episode_4/MS_T1_FLAIR_width640.png){alt="WM mesh from surface segmentation"}
...
![](fig/episode_4/AAL_atlas.png){alt="AAL atlas"}
...
Sometimes the integer index directly correspond to the label list index, e.g. if "visual cortex" is in position 3 in AAL\_dataset\['labels'\] then the corresponding integer index in the image is 3. For the AAL atlas, the ROI indices are not in the order of the text labels so `nilearn` provide a list of ROI indices. Since the list of labels match the list of indices we proceed in two steps:

1. Find the position of the ROI in the list of AAL\_labels
...
![](fig/episode_4/AAL_roi.png){alt="ROI from the AAL atlas"}
...
![](fig/episode_4/destrieux_atlas_left.png){alt="Left hemisphere of the Destrieux surface atlas"}
...
![](fig/episode_4/roi_destrieux.png){alt="ROI of the Destrieux surface atlas"}
